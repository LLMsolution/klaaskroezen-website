...
export function CheckoutForm(props: Props) {
  ...
  return (
    <>
      ...
      {/* Google autofill */}
      <button type="button" onClick={() => onOAuth("google")} className="flex items-center justify-center gap-2 w-full border border-rule py-2.5 text-[12px] text-ink/40 hover:border-ink/30 hover:text-ink/60 transition-colors rounded-[2px] cursor-pointer">
