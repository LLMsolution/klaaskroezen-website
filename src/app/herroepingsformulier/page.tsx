...
export const metadata: Metadata = {
  ...
  description:
    "Standaard modelformulier voor herroeping van een bestelling bij Klaas Kroezen. Print of mail dit formulier om je herroepingsrecht uit te oefenen binnen 14 dagen.",
...
export default function HerroepingsformulierPage() {
  return (
    <section className="py-16 sm:py-[110px] border-b border-rule print:py-0 print:border-none">
      <Container>
        <FadeIn>
          <Label className="mb-3 print:hidden">Juridisch</Label>
          <h1 className="font-display text-[clamp(28px,3.6vw,44px)] font-black leading-[0.97] tracking-[-0.03em] mb-4">
