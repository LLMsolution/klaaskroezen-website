  ...
  const text = {
    nl: {
      ...
      teamMembers: [
        ...
        { name: "Naam invullen", role: "Functie invullen", description: "Beschrijving toevoegen." },
      ],
    ...
    en: {
      ...
      teamMembers: [
        ...
        { name: "Name to fill in", role: "Role to fill in", description: "Description to add." },
      ],
    ...
    de: {
      ...
      teamMembers: [
        ...
        { name: "Name einf\u00fcgen", role: "Funktion einf\u00fcgen", description: "Beschreibung hinzuf\u00fcgen." },
      ],
