  ...
  const text = {
    nl: {
      ...
      teamMembers: [
        ...
        { name: "Naam invullen", role: "Rol invullen", description: "Beschrijving toevoegen." },
      ],
    ...
    de: {
      ...
      teamMembers: [
        ...
        { name: "Name einf\u00fcgen", role: "Rolle einf\u00fcgen", description: "Beschreibung hinzuf\u00fcgen." },
      ],
