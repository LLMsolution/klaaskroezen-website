  ...
  const content = [
    ...
    makeContent(SLUG, "team", "team", "nl", {
      ...
      members: [
        ...
        { name: "Naam invullen", role: "Rol invullen", image: "/images/about/nieuw-teamlid.png", description: "Beschrijving toevoegen." },
      ],
    }),
    makeContent(SLUG, "team", "team", "en", {
      ...
      members: [
        ...
        { name: "Name to fill in", role: "Role to fill in", image: "/images/about/nieuw-teamlid.png", description: "Description to add." },
      ],
    }),
    // ── Office ──
