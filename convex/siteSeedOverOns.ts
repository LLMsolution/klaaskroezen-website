  ...
  const content = [
    ...
    makeContent(SLUG, "team", "team", "nl", {
      ...
      members: [
        ...
        { name: "Naam invullen", role: "Functie invullen", image: "/images/about/vierde-teamlid.png", description: "Beschrijving toevoegen." },
      ],
    }),
    makeContent(SLUG, "team", "team", "en", {
      ...
      members: [
        ...
        { name: "Name to fill in", role: "Role to fill in", image: "/images/about/vierde-teamlid.png", description: "Description to add." },
      ],
    }),
    // ── Office ──
