...
- Register new components (preserve import order for side-effect imports if applicable)
...
- Create integration tests for feature workflow
  - **Pattern:** Test service/business logic functions directly, not framework wrappers
